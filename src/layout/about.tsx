  ...
  return (
    <section id="about" className=" bg-gray-300 dark:bg-slate-900">
      <div className="relative min-h-screen">
        ...
        <div className="absolute inset-0 flex flex-row-reverse space-x-2 space-x-reverse p-4 md:pt-20">
          <h1 className="text-2xl md:text-[120px] font-bold ">
            {t("title-1")}
          </h1>
        </div>
        <div className="absolute inset-0 md:container px-2 md:px-0 flex flex-col mx-auto md:flex-row md:items-center py-5 pt-20">
          <div className="w-full px-4 mb-2 md:mb-0 justify-center items-center">
            <Card className="backdrop-blur-sm bg-white/30 dark:bg-slate-950/40">
              ...
              <CardContent className="md:px-8">
                <div className="grid md:grid-cols-2">
                  <CardDescription>
                    <DirectionAwareHover imageUrl={imageUrl}>
                      <div className="flex items-center mt-4 cursor-pointer">
                        ...
                        <a
                          href="https://instagram/mochalden/"
                          target="_blank"
                  ...
                  <CardDescription className="mt-4 md:-ml-32">
                    ...
                    <Button
                      ...
                      href="https://mail.google.com/mail/u/1/?view=cm&fs=1&to=mch.aldn@gmail.com&tf=1"
                      target="_blank"
                    >
                      <MailIcon />
